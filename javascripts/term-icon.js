...
(function (root, factory) {
  ...
  var termlifeChart = function (element, userOptions) {
    var defaultOptions = {
      barColor: '#27cccb',
      lineCap: 'round',
  ...
  $.fn.termlifeChart = function (options) {

    //Iterate all the dom to draw the termlife-charts
    return this.each(function () {
      if (!$.data(this, 'termlifeChart')) {
        var userOptions = $.extend({}, options, $(this).data());
        $.data(this, 'termlifeChart', new termlifeChart(this, userOptions));
      }
    });
  };
